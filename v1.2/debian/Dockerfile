...
LABEL Description="Fluentd docker image" Version="1.2"
LABEL maintainer "Ashley Felton <ashley.felton@dbca.wa.gov.au>"
...
RUN apt-get update \
 ...
 && gem install fluent-plugin-elasticsearch -v 2.12.0 \
